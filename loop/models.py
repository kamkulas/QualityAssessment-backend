...
class Loop(models.Model):
    ...
    minCr1 = models.DecimalField(max_digits=15, decimal_places=4, blank=True, null=True)
    cr2 = models.DecimalField(max_digits=15, decimal_places=4, blank=True, null=True)
    minCr2 = models.DecimalField(max_digits=15, decimal_places=4, blank=True, null=True)
